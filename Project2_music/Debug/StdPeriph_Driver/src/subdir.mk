...
StdPeriph_Driver/src/%.o: ../StdPeriph_Driver/src/%.c
	...
	@echo $(PWD)
	arm-none-eabi-gcc -mcpu=cortex-m0 -mthumb -mfloat-abi=soft -DSTM32 -DSTM32F0 -DSTM32F051R8Tx -DSTM32F0DISCOVERY -DDEBUG -DSTM32F051 -DUSE_STDPERIPH_DRIVER -I"D:/ECE362/Project2/Utilities" -I"D:/ECE362/Project2/StdPeriph_Driver/inc" -I"D:/ECE362/Project2/inc" -I"D:/ECE362/Project2/CMSIS/device" -I"D:/ECE362/Project2/CMSIS/core" -O0 -g3 -Wall -fmessage-length=0 -ffunction-sections -c -MMD -MP -MF"$(@:%.o=%.d)" -MT"$@" -o "$@" "$<"
